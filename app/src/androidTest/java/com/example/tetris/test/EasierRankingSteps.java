...
public class EasierRankingSteps {
    ...
    private String leerBBDD(){
        ...
        baseDeDatos.rawQuery("select * from "+tipoBBDD+"  order by puntuacion DESC", null);
    ...
    public void newscorworsethanallisgotten() {
        nuevaPartidaJugada();
    }

    @Then("^FirstScoreLosesTen$")
    public void firstscorelosesten() {
        String expected = "Segundo591Primero590Tercero400Cuarto300Quinto200Sexto100";
        String obtained = leerBBDD();
        Assert.assertEquals("Cheking Easier Ranking", expected, obtained);
    }
